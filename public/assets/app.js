...
(function () {
  ...
  __vue_render__._withStripped = true;
    ...
    const __vue_inject_styles__ = function (inject) {
      if (!inject) return
      inject("data-v-09863484_0", { source: ".content[data-v-09863484] {\n  height: 100px;\n  border: 1px solid #f00;\n  width: 100px;\n}\n", map: {"version":3,"sources":["C:\\Users\\lxw\\Desktop\\codework\\v-contextMenu\\example\\App.vue","App.vue"],"names":[],"mappings":"AA8DA;EACA,aAAA;EACA,sBAAA;EACA,YAAA;AC7DA","file":"App.vue","sourcesContent":["<template>\r\n    <div id=\"app\">\r\n        <div class=\"button\" @click=\"toggle\">123</div>\r\n        <contextMenu>\r\n            <div class=\"content\">\r\n                <div>test</div>\r\n                123123\r\n            </div>\r\n            <template slot=\"contextMenu\">\r\n                <context-item\r\n                    v-for=\"menuItem in contextMenu\"\r\n                    :key=\"menuItem.label\"\r\n                    :label=\"menuItem.label\"\r\n                    :divided=\"menuItem.divided\"\r\n                    :disabled=\"menuItem.disabled\"\r\n                    :callback=\"menuItem.callback\"\r\n                    :hotkey=\"menuItem.hotkey\"\r\n                >\r\n                    <template v-slot:icon>\r\n                        <span>icon</span>\r\n                    </template>\r\n                </context-item>\r\n            </template>\r\n        </contextMenu>\r\n    </div>\r\n</template>\r\n\r\n<script>\r\nexport default {\r\n    name: 'App',\r\n\r\n    data: function () {\r\n        return {\r\n            show: false,\r\n            contextMenu: [\r\n                {\r\n                    label: '显示',\r\n                    callback: this.toggle,\r\n                    hotkey: 'enter',\r\n                    disabled: true,\r\n                },\r\n                {\r\n                    label: '粘贴',\r\n                    callback: () => {\r\n                        console.log('粘贴');\r\n                    },\r\n                    hotkey: 'ctrl+v',\r\n                },\r\n            ],\r\n        };\r\n    },\r\n    methods: {\r\n        toggle() {\r\n            console.log('toggle');\r\n            this.show = !this.show;\r\n        },\r\n    },\r\n    mounted() {},\r\n};\r\n</script>\r\n\r\n<style lang=\"stylus\" scoped>\r\n.content\r\n  height 100px\r\n  border 1px solid red\r\n  width 100px\r\n</style>\r\n",".content {\n  height: 100px;\n  border: 1px solid #f00;\n  width: 100px;\n}\n"]}, media: undefined });

    };
    /* scoped */
    const __vue_scope_id__ = "data-v-09863484";
    /* module identifier */
  ...
  var vHotkey_common$1 = /*@__PURE__*/unwrapExports(vHotkey_common);
        ...
        [
          _vm._t("default", [
            ...
            _c("span", { staticClass: "hotkey" }, [
              _vm._v(_vm._s(_vm._f("hotkeyFilter")(_vm.hotkey)))
            ])
          ])
        ],
        2
  ...
  __vue_render__$1._withStripped = true;
    ...
    const __vue_inject_styles__$1 = function (inject) {
      if (!inject) return
      inject("data-v-7fdfd052_0", { source: ".context-item[data-v-7fdfd052] {\n  padding: 10px 30px 10px 16px;\n  cursor: pointer;\n  font-size: 14px;\n  min-width: 240px;\n}\n.context-item[data-v-7fdfd052]:not(.is-disabled):hover {\n  background-color: #f5f5f5;\n}\n.is-disabled[data-v-7fdfd052] {\n  color: rgba(0,0,0,0.1);\n  cursor: not-allowed;\n}\n.divided[data-v-7fdfd052] {\n  height: 1px;\n  width: 100%;\n  margin: 6px 1px;\n  background: rgba(0,0,0,0.1);\n}\n.hotkey[data-v-7fdfd052] {\n  float: right;\n}\n", map: {"version":3,"sources":["C:\\Users\\lxw\\Desktop\\codework\\v-contextMenu\\src\\components\\context-item.vue","context-item.vue"],"names":[],"mappings":"AAiFA;EACA,4BAAA;EACA,eAAA;EACA,eAAA;EACA,gBAAA;AChFA;ADiFA;EACA,yBAAA;AC/EA;ADgFA;EACA,sBAAA;EACA,mBAAA;AC9EA;AD+EA;EACA,WAAA;EACA,WAAA;EACA,eAAA;EACA,2BAAA;AC7EA;AD8EA;EACA,YAAA;AC5EA","file":"context-item.vue","sourcesContent":["<template>\n    <div>\n        <div class=\"divided\" v-if=\"divided\"></div>\n        <div v-hotkey=\"keymap\" class=\"context-item\" @click=\"handleClick\">\n            <slot>\n                <slot name=\"icon\"></slot>\n                <span class=\"label\">{{ label }}</span>\n                <span class=\"hotkey\">{{ hotkey | hotkeyFilter }}</span>\n            </slot>\n        </div>\n    </div>\n</template>\n\n<script>\nimport { directive } from 'v-hotkey';\nimport * as utils from '../utils/index.ts';\nexport default {\n    name: 'context-item',\n    inject: ['$$contextmenu'],\n    props: {\n        divided: {\n            type: Boolean,\n            default: false,\n        },\n        disabled: {\n            type: Boolean,\n            default: false,\n        },\n        label: {\n            type: String,\n        },\n        autoHide: {\n            type: Boolean,\n            default: true,\n        },\n        callback: {\n            type: Function,\n        },\n        hotkey: {\n            type: String,\n        },\n    },\n    computed: {\n        keymap() {\n            let obj = {};\n            if (this.hotkey && !this.disabled) {\n                obj[this.hotkey] = () => {\n                    this.closeContextMenu();\n                    this.callback();\n                };\n            }\n            return obj;\n        },\n    },\n    filters: {\n        hotkeyFilter: utils.hotkeyFilter,\n    },\n    directives: {\n        hotkey: directive,\n    },\n    methods: {\n        closeContextMenu() {\n            if (this.autoHide) {\n                this.$$contextmenu.closeContextMenu();\n            }\n        },\n        handleClick(event) {\n            if (!this.disabled) {\n                if (utils.varType(this.callback) === 'function') {\n                    this.callback();\n                }\n                this.closeContextMenu();\n                this.$emit('click', this, event);\n            }\n        },\n    },\n};\n</script>\n\n<style lang=\"stylus\" scoped>\nborderColor = rgba(0,0,0,0.1)\n.context-item\n    padding: 10px 30px 10px 16px;\n    cursor: pointer;\n    font-size 14px\n    min-width 240px\n    &:not(.is-disabled):hover\n        background-color: #f5f5f5\n.is-disabled\n    color:borderColor\n    cursor: not-allowed\n.divided\n    height: 1px;\n    width: 100%;\n    margin: 6px 1px;\n    background: borderColor\n.hotkey\n  float right\n</style>\n",".context-item {\n  padding: 10px 30px 10px 16px;\n  cursor: pointer;\n  font-size: 14px;\n  min-width: 240px;\n}\n.context-item:not(.is-disabled):hover {\n  background-color: #f5f5f5;\n}\n.is-disabled {\n  color: rgba(0,0,0,0.1);\n  cursor: not-allowed;\n}\n.divided {\n  height: 1px;\n  width: 100%;\n  margin: 6px 1px;\n  background: rgba(0,0,0,0.1);\n}\n.hotkey {\n  float: right;\n}\n"]}, media: undefined });

    };
    /* scoped */
    const __vue_scope_id__$1 = "data-v-7fdfd052";
    /* module identifier */
  ...
  /* template */
    ...
    const __vue_inject_styles__$2 = function (inject) {
      if (!inject) return
      inject("data-v-9e25d8a8_0", { source: ".context-menu[data-v-9e25d8a8] {\n  box-sizing: border-box;\n  position: fixed;\n  left: 0;\n  top: 0;\n  z-index: 100;\n  border-radius: 4px;\n  padding: 10px 0;\n  font-size: 12px;\n  line-height: 1.2;\n  min-width: 10px;\n  word-wrap: break-word;\n  color: #303133;\n  background: #fff;\n  box-shadow: 0 1px 5px rgba(0,0,0,0.2);\n  border: 1px solid #d9d9d9;\n}\n.context-menu-fade-enter-active[data-v-9e25d8a8],\n.context-menu-fade-leave-active[data-v-9e25d8a8] {\n  transition: opacity 0.3s;\n}\n.context-menu-fade-enter[data-v-9e25d8a8],\n.context-menu-fade-leave-to[data-v-9e25d8a8] {\n  opacity: 0;\n}\n", map: {"version":3,"sources":["C:\\Users\\lxw\\Desktop\\codework\\v-contextMenu\\src\\components\\context-menu.vue","context-menu.vue"],"names":[],"mappings":"AA4HA;EACA,sBAAA;EACA,eAAA;EACA,OAAA;EACA,MAAA;EACA,YAAA;EACA,kBAAA;EACA,eAAA;EACA,eAAA;EACA,gBAAA;EACA,eAAA;EACA,qBAAA;EACA,cAAA;EACA,gBAAA;EACA,qCAAA;EACA,yBAAA;AC3HA;AD6HA;;EAEA,wBAAA;AC3HA;AD6HA;;EAEA,UAAA;AC3HA","file":"context-menu.vue","sourcesContent":["<script>\nimport Vue from 'vue';\nimport * as utils from '../utils/index.ts';\nexport default {\n    name: 'context-menu',\n    data() {\n        return {\n            visible: false,\n        };\n    },\n    props: {\n        disabled: {\n            type: Boolean,\n            default: false,\n        },\n    },\n    methods: {\n        handleBodyClick(event) {\n            event.preventDefault();\n            if (event.button === 0) {\n                this.closeContextMenu();\n            }\n            if (event.button === 2) {\n                this.closeContextMenu();\n                this.openContextMenu(event);\n            }\n        },\n        openContextMenu(evt) {\n            if (this.disabled) return;\n            this.visible = true;\n            this.$nextTick(() => {\n                if (!this.$refs.contextMenu) return;\n                let contextMenu = this.$refs.contextMenu,\n                    {\n                        width: menuHeight = 0,\n                        height: menuWidth = 0,\n                    } = contextMenu.getBoundingClientRect(),\n                    position = {},\n                    { x, y } = evt,\n                    { innerWidth: width, innerHeight: height } = window;\n                position.maxWidth = utils.numToPx(width);\n                position.maxHeight = utils.numToPx(height);\n                position.left = utils.placement(menuHeight, x, width);\n                position.top = utils.placement(menuWidth, y, height);\n                Object.assign(contextMenu.style, position);\n                this.$emit('show');\n            });\n        },\n\n        closeContextMenu() {\n            this.visible = false;\n            this.$emit('close');\n        },\n        getFirstElement() {\n            const slots = this.$slots.default;\n            if (!Array.isArray(slots)) {\n                return null;\n            }\n            let element = null;\n            for (let index = 0; index < slots.length; index++) {\n                if (slots[index] && slots[index].tag) {\n                    element = slots[index];\n                }\n            }\n            return element;\n        },\n    },\n\n    mounted() {\n        this.$el.addEventListener('contextmenu', this.handleBodyClick, true);\n        window.addEventListener('click', this.handleBodyClick, true);\n    },\n    beforeCreate() {\n        let that = this;\n        this.menuVm = new Vue({\n            provide() {\n                return {\n                    $$contextmenu: that,\n                };\n            },\n            data: { node: '' },\n            render(h) {\n                //todo 这个地方不知道为什么必须要包裹才能正常渲染，直接返回this.node会渲染为空\n                return <div>{this.node}</div>;\n            },\n        }).$mount();\n    },\n    render(h) {\n        if (this.menuVm) {\n            // this.menuVm.provide = { $$contextmenu: this };\n            this.menuVm.node = (\n                <transition name='context-menu-fade'>\n                    <div\n                        id='context-menu'\n                        class='context-menu'\n                        ref='contextMenu'\n                        v-show={this.visible}\n                    >\n                        {this.$slots.contextMenu}\n                    </div>\n                </transition>\n            );\n        }\n        const firstElement = this.getFirstElement();\n        if (!firstElement) {\n            return null;\n        }\n        if (this.menuVm) {\n            document.body.appendChild(this.menuVm.$el);\n        }\n        return firstElement;\n    },\n    beforeDestroy() {\n        document.body.removeChild(this.menuVm.$el);\n        this.menuVm && this.menuVm.$destroy();\n    },\n    destroyed() {\n        this.$el.removeEventListener('contextmenu', this.handleBodyClick, true);\n        window.removeEventListener('click', this.handleBodyClick, true);\n    },\n};\n</script>\n\n<style lang=\"stylus\" scoped>\n.context-menu\n    box-sizing: border-box;\n    position: fixed;\n    left: 0;\n    top: 0;\n    z-index: 100;\n    border-radius: 4px;\n    padding: 10px 0;\n    font-size: 12px;\n    line-height: 1.2;\n    min-width: 10px;\n    word-wrap: break-word;\n    color: #303133;\n    background: #fff;\n    box-shadow: 0 1px 5px rgba(0, 0, 0, 0.2);\n    border: 1px solid #d9d9d9;\n\n.context-menu-fade-enter-active,\n.context-menu-fade-leave-active\n    transition: opacity 0.3s;\n\n.context-menu-fade-enter,\n.context-menu-fade-leave-to\n    opacity: 0;\n</style>\n",".context-menu {\n  box-sizing: border-box;\n  position: fixed;\n  left: 0;\n  top: 0;\n  z-index: 100;\n  border-radius: 4px;\n  padding: 10px 0;\n  font-size: 12px;\n  line-height: 1.2;\n  min-width: 10px;\n  word-wrap: break-word;\n  color: #303133;\n  background: #fff;\n  box-shadow: 0 1px 5px rgba(0,0,0,0.2);\n  border: 1px solid #d9d9d9;\n}\n.context-menu-fade-enter-active,\n.context-menu-fade-leave-active {\n  transition: opacity 0.3s;\n}\n.context-menu-fade-enter,\n.context-menu-fade-leave-to {\n  opacity: 0;\n}\n"]}, media: undefined });

    };
    /* scoped */
    const __vue_scope_id__$2 = "data-v-9e25d8a8";
    /* module identifier */
